...
<Image
  ...
  loading={"eager"}
  alt={"dani-akash"}
  class={"h-64 w-64 -rotate-3 rounded-3xl transition-all hover:rotate-0"}
/>
...
- **Developed Client SDKs:** Created client SDKs for Svelte, Relay, and Expo at [WunderGraph](https://wundergraph.com/), which were well-documented, tested, and widely adopted by customers.
